...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usernameFromSession == null) {
            ...
            if (usernameFromParameter == null || usernameFromParameter.isEmpty()) {
                ...
                synchronized (this) {
                    if (userManager.isUserExists(usernameFromParameter)) {
                        ...
                        //engine.addCustomer(usernameFromParameter,0);
                        ...
                        response.sendRedirect(CHAT_ROOM_URL);//TODO
                        //response.sendRedirect(userName + " has logged in successfully!");//.setMessageOnResponse(response.getWriter(), userName + " has logged in successfully!");


                        //FROM ITAMAR PROJECT-CONNECT TO ENGINE
            ...
            //response.sendRedirect(userName + " already in!");
